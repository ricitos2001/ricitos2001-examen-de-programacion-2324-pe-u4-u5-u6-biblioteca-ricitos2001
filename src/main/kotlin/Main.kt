...
fun main() {
    ...
    val libro1 = Libros("1234567A", "El señor de los anillos", "J.R.R. Tolkien", "11/11/2001", "fantasia", DISPONIBLE)
    val libro2 = Libros("1234567B", "Harry Potter", "J.K. Rowling", "11/11/2001", "Fantasia", PRESTADO)
    val libro3 = Libros("1234567C", "El Libro del buen humor", "cesar gabriel ucha sousa", "11/11/2024", "humor", DISPONIBLE)
